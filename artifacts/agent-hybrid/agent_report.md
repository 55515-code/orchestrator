...
- Generated at: 2026-09-17T08:38:29.740573+00:00
- Session: `20260917-79f9381c`
- Mode: `deep`
- Loop count: `6`
- Route: `cloud_agent`
- Target branch: `main`
...
- Current branch: `agent/swarm-20260917-79f9381c`
- Target branch: `main`
...
```json
{
  ...
  "target_branch": "main",
  "allow_write": true,
  "session_id": "20260917-79f9381c",
  "loop_count": 6,
  "generated_at": "2026-09-17T08:38:29.740573+00:00",
  "started_at": "2026-09-17T08:38:01.724609+00:00",
  "findings": [
    "Loop 1: All deterministic checks in this loop succeeded.",
    "Loop 2: All deterministic checks in this loop succeeded.",
    "Loop 3: All deterministic checks in this loop succeeded.",
  ...
  "loop_results": [
    {
      "loop_index": 1,
      "started_at": "2026-09-17T08:38:01.983055+00:00",
      "generated_at": "2026-09-17T08:38:06.086721+00:00",
      "route": "deterministic",
      ...
      "publish_result": {
        ...
        "ok": false,
        "branch": "agent/swarm-20260917-79f9381c",
        "pr_number": 0,
        "pr_url": "",
    ...
    {
      "loop_index": 2,
      "started_at": "2026-09-17T08:38:09.981501+00:00",
      "generated_at": "2026-09-17T08:38:11.153440+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 3,
      "started_at": "2026-09-17T08:38:14.718337+00:00",
      "generated_at": "2026-09-17T08:38:15.896342+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 4,
      "started_at": "2026-09-17T08:38:19.138665+00:00",
      "generated_at": "2026-09-17T08:38:20.366735+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 5,
      "started_at": "2026-09-17T08:38:23.454948+00:00",
      "generated_at": "2026-09-17T08:38:24.652121+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 6,
      "started_at": "2026-09-17T08:38:28.310982+00:00",
      "generated_at": "2026-09-17T08:38:29.496133+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
  ...
  "git_context": {
    "current_branch": "agent/swarm-20260917-79f9381c",
    "target_branch": "main",
    "head_sha": "87df72387b466be44b72fa6a40b7e9234ff60498",
  ...
  "git_actions": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 1 6 20260917-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.637,
      "stdout_tail": "[agent/swarm-20260917-79f9381c 10dc8fa0] chore(agent): swarm loop 1/6 session 20260917-79f9381c\n 2 files changed, 739 insertions(+), 130 deletions(-)\nCurrent branch agent/swarm-20260917-79f9381c is up to date.\nbranch 'agent/swarm-20260917-79f9381c' set up to track 'origin/agent/swarm-20260917-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260917-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nSwitched to a new branch 'agent/swarm-20260917-79f9381c'\nremote: \nremote: Create a pull request for 'agent/swarm-20260917-79f9381c' on GitHub by visiting:        \nremote:      https://github.com/55515-code/orchestrator/pull/new/agent/swarm-20260917-79f9381c        \nremote: \nTo https://github.com/55515-code/orchestrator\n * [new branch]        agent/swarm-20260917-79f9381c -> agent/swarm-20260917-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "agent/swarm-20260917-79f9381c\n",
      "stderr_tail": ""
    },
    {
      "command": [
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "10dc8fa0bf113e10af9d17ce2f83ecfc7fe780b8\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 2 6 20260917-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.312,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260917-79f9381c'.\n[agent/swarm-20260917-79f9381c 3ffff319] chore(agent): swarm loop 2/6 session 20260917-79f9381c\n 2 files changed, 495 insertions(+), 18 deletions(-)\nCurrent branch agent/swarm-20260917-79f9381c is up to date.\nbranch 'agent/swarm-20260917-79f9381c' set up to track 'origin/agent/swarm-20260917-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260917-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260917-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   10dc8fa0..3ffff319  agent/swarm-20260917-79f9381c -> agent/swarm-20260917-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "3ffff31919d820e486df11dab977971dc6f35b31\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 3 6 20260917-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.02,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260917-79f9381c'.\n[agent/swarm-20260917-79f9381c adc179ba] chore(agent): swarm loop 3/6 session 20260917-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260917-79f9381c is up to date.\nbranch 'agent/swarm-20260917-79f9381c' set up to track 'origin/agent/swarm-20260917-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260917-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260917-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   3ffff319..adc179ba  agent/swarm-20260917-79f9381c -> agent/swarm-20260917-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "adc179ba6d62f319266bf8b4be7f814bf2a6034a\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 4 6 20260917-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.852,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260917-79f9381c'.\n[agent/swarm-20260917-79f9381c 86dddb0c] chore(agent): swarm loop 4/6 session 20260917-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260917-79f9381c is up to date.\nbranch 'agent/swarm-20260917-79f9381c' set up to track 'origin/agent/swarm-20260917-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260917-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260917-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   adc179ba..86dddb0c  agent/swarm-20260917-79f9381c -> agent/swarm-20260917-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "86dddb0c7ce9297f4fc3a4a6f673fd9a50c360a1\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 5 6 20260917-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.415,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260917-79f9381c'.\n[agent/swarm-20260917-79f9381c 87df7238] chore(agent): swarm loop 5/6 session 20260917-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260917-79f9381c is up to date.\nbranch 'agent/swarm-20260917-79f9381c' set up to track 'origin/agent/swarm-20260917-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260917-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260917-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   86dddb0c..87df7238  agent/swarm-20260917-79f9381c -> agent/swarm-20260917-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "87df72387b466be44b72fa6a40b7e9234ff60498\n",
      "stderr_tail": ""
    },
    {
      "command": [
