...
- Generated at: 2026-08-28T15:21:30.856012+00:00
- Session: `20260828-ecd59e5`
- Mode: `deep`
- Loop count: `6`
- Route: `cloud_agent`
- Target branch: `main`
...
- Current branch: `agent/swarm-20260828-ecd59e5`
- Target branch: `main`
...
```json
{
  ...
  "target_branch": "main",
  "allow_write": true,
  "session_id": "20260828-ecd59e5",
  "loop_count": 6,
  "generated_at": "2026-08-28T15:21:30.856012+00:00",
  "started_at": "2026-08-28T15:20:56.690811+00:00",
  "findings": [
    "Loop 1: 1 command(s) failed during mode 'deep'.",
    "Loop 1: Failed: uv run --with ruff ruff check substrate scripts tests (rc=1)",
    "Loop 2: 1 command(s) failed during mode 'deep'.",
  ...
  "loop_results": [
    {
      "loop_index": 1,
      "started_at": "2026-08-28T15:20:57.158568+00:00",
      "generated_at": "2026-08-28T15:21:01.842669+00:00",
      "route": "deterministic",
      ...
      "publish_result": {
        ...
        "ok": false,
        "branch": "agent/swarm-20260828-ecd59e5",
        "pr_number": 0,
        "pr_url": "",
    ...
    {
      "loop_index": 2,
      "started_at": "2026-08-28T15:21:06.166590+00:00",
      "generated_at": "2026-08-28T15:21:07.528710+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 3,
      "started_at": "2026-08-28T15:21:11.559050+00:00",
      "generated_at": "2026-08-28T15:21:12.854091+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 4,
      "started_at": "2026-08-28T15:21:17.053707+00:00",
      "generated_at": "2026-08-28T15:21:18.326684+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 5,
      "started_at": "2026-08-28T15:21:22.207058+00:00",
      "generated_at": "2026-08-28T15:21:23.509706+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 6,
      "started_at": "2026-08-28T15:21:29.145031+00:00",
      "generated_at": "2026-08-28T15:21:30.453513+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
  ...
  "git_context": {
    "current_branch": "agent/swarm-20260828-ecd59e5",
    "target_branch": "main",
    "head_sha": "de460c7230541be22c5db4221652a639db51aab0",
    "target_sha": "ecd59e5bd84814e695b73a685cabf466b1f09306",
    "ahead_count": 5,
    "behind_count": 0,
    "diverged": false,
  ...
  "git_actions": [
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "ecd59e5bd84814e695b73a685cabf466b1f09306\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "agent/swarm-20260828-ecd59e5\n",
      "stderr_tail": ""
    },
    {
      "command": [
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "6bec8f6f608049057f1d9dd4655f70a2132edbf8\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 2 6 20260828-ecd59e5 safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.662,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260828-ecd59e5'.\n[agent/swarm-20260828-ecd59e5 d154f96] chore(agent): swarm loop 2/6 session 20260828-ecd59e5\n 2 files changed, 498 insertions(+), 16 deletions(-)\nCurrent branch agent/swarm-20260828-ecd59e5 is up to date.\nbranch 'agent/swarm-20260828-ecd59e5' set up to track 'origin/agent/swarm-20260828-ecd59e5'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260828-ecd59e5\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260828-ecd59e5'\nTo https://github.com/55515-code/orchestrator\n   6bec8f6..d154f96  agent/swarm-20260828-ecd59e5 -> agent/swarm-20260828-ecd59e5\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "d154f968f7c1e54a4a11df234879fa7c5ee506e1\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 3 6 20260828-ecd59e5 safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.818,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260828-ecd59e5'.\n[agent/swarm-20260828-ecd59e5 1158642] chore(agent): swarm loop 3/6 session 20260828-ecd59e5\n 2 files changed, 491 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260828-ecd59e5 is up to date.\nbranch 'agent/swarm-20260828-ecd59e5' set up to track 'origin/agent/swarm-20260828-ecd59e5'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260828-ecd59e5\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260828-ecd59e5'\nTo https://github.com/55515-code/orchestrator\n   d154f96..1158642  agent/swarm-20260828-ecd59e5 -> agent/swarm-20260828-ecd59e5\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "1158642a3be935e3d4f76685e94afa7cf245db2a\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 4 6 20260828-ecd59e5 safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.496,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260828-ecd59e5'.\n[agent/swarm-20260828-ecd59e5 3d72da4] chore(agent): swarm loop 4/6 session 20260828-ecd59e5\n 2 files changed, 491 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260828-ecd59e5 is up to date.\nbranch 'agent/swarm-20260828-ecd59e5' set up to track 'origin/agent/swarm-20260828-ecd59e5'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260828-ecd59e5\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260828-ecd59e5'\nTo https://github.com/55515-code/orchestrator\n   1158642..3d72da4  agent/swarm-20260828-ecd59e5 -> agent/swarm-20260828-ecd59e5\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "3d72da46f08479eb2887d7a900e3cfd784fcaa31\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 5 6 20260828-ecd59e5 safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 5.239,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260828-ecd59e5'.\n[agent/swarm-20260828-ecd59e5 de460c7] chore(agent): swarm loop 5/6 session 20260828-ecd59e5\n 2 files changed, 491 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260828-ecd59e5 is up to date.\nbranch 'agent/swarm-20260828-ecd59e5' set up to track 'origin/agent/swarm-20260828-ecd59e5'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260828-ecd59e5\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260828-ecd59e5'\nTo https://github.com/55515-code/orchestrator\n   3d72da4..de460c7  agent/swarm-20260828-ecd59e5 -> agent/swarm-20260828-ecd59e5\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "de460c7230541be22c5db4221652a639db51aab0\n",
      "stderr_tail": ""
    },
    {
      "command": [
