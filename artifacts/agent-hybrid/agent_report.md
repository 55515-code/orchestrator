...
- Generated at: 2026-08-30T09:12:57.396483+00:00
- Session: `20260830-ac6aa4b`
- Mode: `deep`
- Loop count: `6`
- Route: `cloud_agent`
- Target branch: `main`
...
- Current branch: `agent/swarm-20260830-ac6aa4b`
- Target branch: `main`
...
```json
{
  ...
  "target_branch": "main",
  "allow_write": true,
  "session_id": "20260830-ac6aa4b",
  "loop_count": 6,
  "generated_at": "2026-08-30T09:12:57.396483+00:00",
  "started_at": "2026-08-30T09:12:30.696574+00:00",
  "findings": [
    "Loop 1: 1 command(s) failed during mode 'deep'.",
    "Loop 1: Failed: uv run --with ruff ruff check substrate scripts tests (rc=1)",
    "Loop 2: 1 command(s) failed during mode 'deep'.",
  ...
  "loop_results": [
    {
      "loop_index": 1,
      "started_at": "2026-08-30T09:12:31.001239+00:00",
      "generated_at": "2026-08-30T09:12:35.881825+00:00",
      "route": "deterministic",
      ...
      "publish_result": {
        ...
        "ok": false,
        "branch": "agent/swarm-20260830-ac6aa4b",
        "pr_number": 0,
        "pr_url": "",
    ...
    {
      "loop_index": 2,
      "started_at": "2026-08-30T09:12:39.158258+00:00",
      "generated_at": "2026-08-30T09:12:40.516551+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 3,
      "started_at": "2026-08-30T09:12:43.594436+00:00",
      "generated_at": "2026-08-30T09:12:44.860722+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 4,
      "started_at": "2026-08-30T09:12:47.664419+00:00",
      "generated_at": "2026-08-30T09:12:48.924230+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 5,
      "started_at": "2026-08-30T09:12:51.847073+00:00",
      "generated_at": "2026-08-30T09:12:53.109685+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 6,
      "started_at": "2026-08-30T09:12:55.850630+00:00",
      "generated_at": "2026-08-30T09:12:57.165993+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
  ...
  "git_context": {
    "current_branch": "agent/swarm-20260830-ac6aa4b",
    "target_branch": "main",
    "head_sha": "a11944e4c886d4bcd60438bfabcba8dcf0244a04",
    "target_sha": "ac6aa4b8dcfaabc857db78378e2b68475ef7e4ad",
    "ahead_count": 5,
    "behind_count": 0,
    "diverged": false,
  ...
  "git_actions": [
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "ac6aa4b8dcfaabc857db78378e2b68475ef7e4ad\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "agent/swarm-20260830-ac6aa4b\n",
      "stderr_tail": ""
    },
    {
      "command": [
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "a7ed07db997d0243e4e2b154955026a4326a0d94\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 2 6 20260830-ac6aa4b safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.843,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260830-ac6aa4b'.\n[agent/swarm-20260830-ac6aa4b 6c057a7] chore(agent): swarm loop 2/6 session 20260830-ac6aa4b\n 2 files changed, 498 insertions(+), 16 deletions(-)\nCurrent branch agent/swarm-20260830-ac6aa4b is up to date.\nbranch 'agent/swarm-20260830-ac6aa4b' set up to track 'origin/agent/swarm-20260830-ac6aa4b'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260830-ac6aa4b\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260830-ac6aa4b'\nTo https://github.com/55515-code/orchestrator\n   a7ed07d..6c057a7  agent/swarm-20260830-ac6aa4b -> agent/swarm-20260830-ac6aa4b\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "6c057a7bab758e2aeebee165b5060324573872c5\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 3 6 20260830-ac6aa4b safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.56,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260830-ac6aa4b'.\n[agent/swarm-20260830-ac6aa4b 53e402f] chore(agent): swarm loop 3/6 session 20260830-ac6aa4b\n 2 files changed, 491 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260830-ac6aa4b is up to date.\nbranch 'agent/swarm-20260830-ac6aa4b' set up to track 'origin/agent/swarm-20260830-ac6aa4b'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260830-ac6aa4b\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260830-ac6aa4b'\nTo https://github.com/55515-code/orchestrator\n   6c057a7..53e402f  agent/swarm-20260830-ac6aa4b -> agent/swarm-20260830-ac6aa4b\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "53e402f8e3d0c64cba786efbb4c4c9441ee9e4b8\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 4 6 20260830-ac6aa4b safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.696,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260830-ac6aa4b'.\n[agent/swarm-20260830-ac6aa4b 58776ac] chore(agent): swarm loop 4/6 session 20260830-ac6aa4b\n 2 files changed, 491 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260830-ac6aa4b is up to date.\nbranch 'agent/swarm-20260830-ac6aa4b' set up to track 'origin/agent/swarm-20260830-ac6aa4b'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260830-ac6aa4b\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260830-ac6aa4b'\nTo https://github.com/55515-code/orchestrator\n   53e402f..58776ac  agent/swarm-20260830-ac6aa4b -> agent/swarm-20260830-ac6aa4b\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "58776acd1a0c3533e427b7ce0da9ac85a5c48779\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 5 6 20260830-ac6aa4b safe_gate 1 false",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.528,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260830-ac6aa4b'.\n[agent/swarm-20260830-ac6aa4b a11944e] chore(agent): swarm loop 5/6 session 20260830-ac6aa4b\n 2 files changed, 491 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260830-ac6aa4b is up to date.\nbranch 'agent/swarm-20260830-ac6aa4b' set up to track 'origin/agent/swarm-20260830-ac6aa4b'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260830-ac6aa4b\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260830-ac6aa4b'\nTo https://github.com/55515-code/orchestrator\n   58776ac..a11944e  agent/swarm-20260830-ac6aa4b -> agent/swarm-20260830-ac6aa4b\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "a11944e4c886d4bcd60438bfabcba8dcf0244a04\n",
      "stderr_tail": ""
    },
    {
      "command": [
