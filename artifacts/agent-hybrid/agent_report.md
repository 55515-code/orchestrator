...
- Generated at: 2026-09-24T08:26:30.438971+00:00
- Session: `20260924-79f9381c`
- Mode: `deep`
- Loop count: `6`
- Route: `cloud_agent`
- Target branch: `main`
...
- Current branch: `agent/swarm-20260924-79f9381c`
- Target branch: `main`
...
```json
{
  ...
  "target_branch": "main",
  "allow_write": true,
  "session_id": "20260924-79f9381c",
  "loop_count": 6,
  "generated_at": "2026-09-24T08:26:30.438971+00:00",
  "started_at": "2026-09-24T08:26:01.059059+00:00",
  "findings": [
    "Loop 1: All deterministic checks in this loop succeeded.",
    "Loop 2: All deterministic checks in this loop succeeded.",
    "Loop 3: All deterministic checks in this loop succeeded.",
  ...
  "loop_results": [
    {
      "loop_index": 1,
      "started_at": "2026-09-24T08:26:01.393120+00:00",
      "generated_at": "2026-09-24T08:26:05.383696+00:00",
      "route": "deterministic",
      ...
      "publish_result": {
        ...
        "ok": false,
        "branch": "agent/swarm-20260924-79f9381c",
        "pr_number": 0,
        "pr_url": "",
    ...
    {
      "loop_index": 2,
      "started_at": "2026-09-24T08:26:09.326542+00:00",
      "generated_at": "2026-09-24T08:26:10.516216+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 3,
      "started_at": "2026-09-24T08:26:14.245378+00:00",
      "generated_at": "2026-09-24T08:26:15.432789+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 4,
      "started_at": "2026-09-24T08:26:19.348699+00:00",
      "generated_at": "2026-09-24T08:26:20.543687+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 5,
      "started_at": "2026-09-24T08:26:24.228262+00:00",
      "generated_at": "2026-09-24T08:26:25.425907+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 6,
      "started_at": "2026-09-24T08:26:28.949546+00:00",
      "generated_at": "2026-09-24T08:26:30.142941+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
  ...
  "git_context": {
    "current_branch": "agent/swarm-20260924-79f9381c",
    "target_branch": "main",
    "head_sha": "f0b5a5f6aa0ae516b72e05f006216052d696d64f",
  ...
  "git_actions": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 1 6 20260924-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.654,
      "stdout_tail": "[agent/swarm-20260924-79f9381c cba1420b] chore(agent): swarm loop 1/6 session 20260924-79f9381c\n 2 files changed, 739 insertions(+), 130 deletions(-)\nCurrent branch agent/swarm-20260924-79f9381c is up to date.\nbranch 'agent/swarm-20260924-79f9381c' set up to track 'origin/agent/swarm-20260924-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260924-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nSwitched to a new branch 'agent/swarm-20260924-79f9381c'\nremote: \nremote: Create a pull request for 'agent/swarm-20260924-79f9381c' on GitHub by visiting:        \nremote:      https://github.com/55515-code/orchestrator/pull/new/agent/swarm-20260924-79f9381c        \nremote: \nTo https://github.com/55515-code/orchestrator\n * [new branch]        agent/swarm-20260924-79f9381c -> agent/swarm-20260924-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "agent/swarm-20260924-79f9381c\n",
      "stderr_tail": ""
    },
    {
      "command": [
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "cba1420b987826b67cb69864dcbec3af9612e6a7\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 2 6 20260924-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.432,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260924-79f9381c'.\n[agent/swarm-20260924-79f9381c c5446fd1] chore(agent): swarm loop 2/6 session 20260924-79f9381c\n 2 files changed, 495 insertions(+), 18 deletions(-)\nCurrent branch agent/swarm-20260924-79f9381c is up to date.\nbranch 'agent/swarm-20260924-79f9381c' set up to track 'origin/agent/swarm-20260924-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260924-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260924-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   cba1420b..c5446fd1  agent/swarm-20260924-79f9381c -> agent/swarm-20260924-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "c5446fd1787785b4caef958120198a56c58bc39b\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 3 6 20260924-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.613,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260924-79f9381c'.\n[agent/swarm-20260924-79f9381c 586af4ac] chore(agent): swarm loop 3/6 session 20260924-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260924-79f9381c is up to date.\nbranch 'agent/swarm-20260924-79f9381c' set up to track 'origin/agent/swarm-20260924-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260924-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260924-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   c5446fd1..586af4ac  agent/swarm-20260924-79f9381c -> agent/swarm-20260924-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "586af4ac3144961e2c50122bd788eb8f7325e6e6\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 4 6 20260924-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.394,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260924-79f9381c'.\n[agent/swarm-20260924-79f9381c 30dd92c0] chore(agent): swarm loop 4/6 session 20260924-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260924-79f9381c is up to date.\nbranch 'agent/swarm-20260924-79f9381c' set up to track 'origin/agent/swarm-20260924-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260924-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260924-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   586af4ac..30dd92c0  agent/swarm-20260924-79f9381c -> agent/swarm-20260924-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "30dd92c0a9bf9f62d3b48c6df5d316902d1b4e84\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 5 6 20260924-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.233,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260924-79f9381c'.\n[agent/swarm-20260924-79f9381c f0b5a5f6] chore(agent): swarm loop 5/6 session 20260924-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260924-79f9381c is up to date.\nbranch 'agent/swarm-20260924-79f9381c' set up to track 'origin/agent/swarm-20260924-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260924-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260924-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   30dd92c0..f0b5a5f6  agent/swarm-20260924-79f9381c -> agent/swarm-20260924-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "f0b5a5f6aa0ae516b72e05f006216052d696d64f\n",
      "stderr_tail": ""
    },
    {
      "command": [
