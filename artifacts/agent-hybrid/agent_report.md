...
- Generated at: 2026-05-27T07:14:07.612470+00:00
- Session: `20260527-f79194c`
- Mode: `deep`
- Loop count: `6`
...
- Current branch: `agent/swarm-20260527-f79194c`
- Target branch: `main`
...
```json
{
  ...
  "target_branch": "main",
  "allow_write": true,
  "session_id": "20260527-f79194c",
  "loop_count": 6,
  "generated_at": "2026-05-27T07:14:07.612470+00:00",
  "started_at": "2026-05-27T07:13:09.110048+00:00",
  "findings": [
    "Loop 1: 1 command(s) failed during mode 'deep'.",
    "Loop 1: Failed: codex cloud exec --attempts 1 'Follow prompts/cloud_agent_hybrid_operator.md. Perform deep analysis, testing, research planning, and development guidance for this repository.' (rc=127)",
    "Loop 2: 1 command(s) failed during mode 'deep'.",
  ...
  "loop_results": [
    {
      "loop_index": 1,
      "started_at": "2026-05-27T07:13:09.431238+00:00",
      "generated_at": "2026-05-27T07:13:20.143706+00:00",
      "route": "fallback_local_mock",
      ...
      "publish_result": {
        ...
        "ok": false,
        "branch": "agent/swarm-20260527-f79194c",
        "pr_number": 0,
        "pr_url": "",
    ...
    {
      "loop_index": 2,
      "started_at": "2026-05-27T07:13:24.020740+00:00",
      "generated_at": "2026-05-27T07:13:30.273681+00:00",
      "route": "fallback_local_mock",
      "cloud_attempted": true,
      "cloud_success": false,
      "cloud_note": "Cloud agent unavailable or failed; fallback completed.",
      ...
      "command_results": [
        ...
        },
        {
          ...
          "stdout_tail": "[\n  {\n    \"scanned_at\": \"2026-05-27T07:13:27.498354+00:00\",\n    \"repo_slug\": \"substrate-core\",\n    \"repo_path\": \"/home/runner/work/orchestrator/orchestrator\",\n    \"is_git_repo\": true,\n    \"details\": {\n      \"allow_mutations\": true,\n      \"default_mode\": \"mutate\",\n      \"tasks\": [\n        \"chain_run\",\n        \"developer_polish\",\n        \"docs_serve\",\n        \"ops_panel\",\n        \"probe_system\"\n      ]\n    },\n    \"branch\": \"agent/swarm-20260527-f79194c\",\n    \"dirty\": false,\n    \"last_commit_at\": \"2026-05-27T07:13:20Z\",\n    \"remote_url\": \"https://github.com/55515-code/orchestrator\",\n    \"default_branch\": \"main\"\n  }\n]\n",
          "stderr_tail": ""
        },
        {
          "command": [
    ...
    {
      "loop_index": 3,
      "started_at": "2026-05-27T07:13:33.281214+00:00",
      "generated_at": "2026-05-27T07:13:39.452242+00:00",
      "route": "fallback_local_mock",
      "cloud_attempted": true,
      "cloud_success": false,
      "cloud_note": "Cloud agent unavailable or failed; fallback completed.",
      ...
      "command_results": [
        ...
        },
        {
          ...
          "stdout_tail": "[\n  {\n    \"scanned_at\": \"2026-05-27T07:13:36.677503+00:00\",\n    \"repo_slug\": \"substrate-core\",\n    \"repo_path\": \"/home/runner/work/orchestrator/orchestrator\",\n    \"is_git_repo\": true,\n    \"details\": {\n      \"allow_mutations\": true,\n      \"default_mode\": \"mutate\",\n      \"tasks\": [\n        \"chain_run\",\n        \"developer_polish\",\n        \"docs_serve\",\n        \"ops_panel\",\n        \"probe_system\"\n      ]\n    },\n    \"branch\": \"agent/swarm-20260527-f79194c\",\n    \"dirty\": false,\n    \"last_commit_at\": \"2026-05-27T07:13:30Z\",\n    \"remote_url\": \"https://github.com/55515-code/orchestrator\",\n    \"default_branch\": \"main\"\n  }\n]\n",
          "stderr_tail": ""
        },
        {
          "command": [
    ...
    {
      "loop_index": 4,
      "started_at": "2026-05-27T07:13:42.631294+00:00",
      "generated_at": "2026-05-27T07:13:48.729434+00:00",
      "route": "fallback_local_mock",
      "cloud_attempted": true,
      "cloud_success": false,
      "cloud_note": "Cloud agent unavailable or failed; fallback completed.",
      ...
      "command_results": [
        ...
        },
        {
          ...
          "stdout_tail": "[\n  {\n    \"scanned_at\": \"2026-05-27T07:13:45.966126+00:00\",\n    \"repo_slug\": \"substrate-core\",\n    \"repo_path\": \"/home/runner/work/orchestrator/orchestrator\",\n    \"is_git_repo\": true,\n    \"details\": {\n      \"allow_mutations\": true,\n      \"default_mode\": \"mutate\",\n      \"tasks\": [\n        \"chain_run\",\n        \"developer_polish\",\n        \"docs_serve\",\n        \"ops_panel\",\n        \"probe_system\"\n      ]\n    },\n    \"branch\": \"agent/swarm-20260527-f79194c\",\n    \"dirty\": false,\n    \"last_commit_at\": \"2026-05-27T07:13:39Z\",\n    \"remote_url\": \"https://github.com/55515-code/orchestrator\",\n    \"default_branch\": \"main\"\n  }\n]\n",
          "stderr_tail": ""
        },
        {
          "command": [
    ...
    {
      "loop_index": 5,
      "started_at": "2026-05-27T07:13:51.828540+00:00",
      "generated_at": "2026-05-27T07:13:57.949685+00:00",
      "route": "fallback_local_mock",
      "cloud_attempted": true,
      "cloud_success": false,
      "cloud_note": "Cloud agent unavailable or failed; fallback completed.",
      ...
      "command_results": [
        ...
        },
        {
          ...
          "stdout_tail": "[\n  {\n    \"scanned_at\": \"2026-05-27T07:13:55.205085+00:00\",\n    \"repo_slug\": \"substrate-core\",\n    \"repo_path\": \"/home/runner/work/orchestrator/orchestrator\",\n    \"is_git_repo\": true,\n    \"details\": {\n      \"allow_mutations\": true,\n      \"default_mode\": \"mutate\",\n      \"tasks\": [\n        \"chain_run\",\n        \"developer_polish\",\n        \"docs_serve\",\n        \"ops_panel\",\n        \"probe_system\"\n      ]\n    },\n    \"branch\": \"agent/swarm-20260527-f79194c\",\n    \"dirty\": false,\n    \"last_commit_at\": \"2026-05-27T07:13:49Z\",\n    \"remote_url\": \"https://github.com/55515-code/orchestrator\",\n    \"default_branch\": \"main\"\n  }\n]\n",
          "stderr_tail": ""
        },
        {
          "command": [
    ...
    {
      "loop_index": 6,
      "started_at": "2026-05-27T07:14:00.816373+00:00",
      "generated_at": "2026-05-27T07:14:07.382704+00:00",
      "route": "fallback_local_mock",
      "cloud_attempted": true,
      "cloud_success": false,
      "cloud_note": "Cloud agent unavailable or failed; fallback completed.",
      ...
      "command_results": [
        ...
        },
        {
          ...
          "stdout_tail": "[\n  {\n    \"scanned_at\": \"2026-05-27T07:14:04.367660+00:00\",\n    \"repo_slug\": \"substrate-core\",\n    \"repo_path\": \"/home/runner/work/orchestrator/orchestrator\",\n    \"is_git_repo\": true,\n    \"details\": {\n      \"allow_mutations\": true,\n      \"default_mode\": \"mutate\",\n      \"tasks\": [\n        \"chain_run\",\n        \"developer_polish\",\n        \"docs_serve\",\n        \"ops_panel\",\n        \"probe_system\"\n      ]\n    },\n    \"branch\": \"agent/swarm-20260527-f79194c\",\n    \"dirty\": false,\n    \"last_commit_at\": \"2026-05-27T07:13:58Z\",\n    \"remote_url\": \"https://github.com/55515-code/orchestrator\",\n    \"default_branch\": \"main\"\n  }\n]\n",
          "stderr_tail": ""
        },
        {
          "command": [
  ...
  "git_context": {
    "current_branch": "agent/swarm-20260527-f79194c",
    "target_branch": "main",
    "head_sha": "06e4a45c3c8b9b3d9b072d97f83675265c5a17a7",
  ...
  "git_actions": [
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "agent/swarm-20260527-f79194c\n",
      "stderr_tail": ""
    },
    {
      "command": [
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "4c9593f273d3c0f7237d99663af20c41919a2081\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 2 6 20260527-f79194c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.778,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260527-f79194c'.\n[agent/swarm-20260527-f79194c cb94a74] chore(agent): swarm loop 2/6 session 20260527-f79194c\n 2 files changed, 638 insertions(+), 133 deletions(-)\nCurrent branch agent/swarm-20260527-f79194c is up to date.\nbranch 'agent/swarm-20260527-f79194c' set up to track 'origin/agent/swarm-20260527-f79194c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260527-f79194c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260527-f79194c'\nTo https://github.com/55515-code/orchestrator\n   4c9593f..cb94a74  agent/swarm-20260527-f79194c -> agent/swarm-20260527-f79194c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "cb94a74b0fc3b7f38fe5eab0ffdf129fe9406550\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 3 6 20260527-f79194c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.995,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260527-f79194c'.\n[agent/swarm-20260527-f79194c 42141e8] chore(agent): swarm loop 3/6 session 20260527-f79194c\n 2 files changed, 624 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260527-f79194c is up to date.\nbranch 'agent/swarm-20260527-f79194c' set up to track 'origin/agent/swarm-20260527-f79194c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260527-f79194c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260527-f79194c'\nTo https://github.com/55515-code/orchestrator\n   cb94a74..42141e8  agent/swarm-20260527-f79194c -> agent/swarm-20260527-f79194c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "42141e81506c311c5a2b2461d940895623706f6b\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 4 6 20260527-f79194c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.877,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260527-f79194c'.\n[agent/swarm-20260527-f79194c b000b94] chore(agent): swarm loop 4/6 session 20260527-f79194c\n 2 files changed, 624 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260527-f79194c is up to date.\nbranch 'agent/swarm-20260527-f79194c' set up to track 'origin/agent/swarm-20260527-f79194c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260527-f79194c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260527-f79194c'\nTo https://github.com/55515-code/orchestrator\n   42141e8..b000b94  agent/swarm-20260527-f79194c -> agent/swarm-20260527-f79194c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "b000b94a58cfad90b5dc1c36e4a32060a60f515a\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 5 6 20260527-f79194c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.617,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260527-f79194c'.\n[agent/swarm-20260527-f79194c 06e4a45] chore(agent): swarm loop 5/6 session 20260527-f79194c\n 2 files changed, 624 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260527-f79194c is up to date.\nbranch 'agent/swarm-20260527-f79194c' set up to track 'origin/agent/swarm-20260527-f79194c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260527-f79194c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch            main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260527-f79194c'\nTo https://github.com/55515-code/orchestrator\n   b000b94..06e4a45  agent/swarm-20260527-f79194c -> agent/swarm-20260527-f79194c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "06e4a45c3c8b9b3d9b072d97f83675265c5a17a7\n",
      "stderr_tail": ""
    },
    {
      "command": [
