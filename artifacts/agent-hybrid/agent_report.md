...
- Generated at: 2026-09-23T08:33:43.032562+00:00
- Session: `20260923-79f9381c`
- Mode: `deep`
- Loop count: `6`
- Route: `cloud_agent`
- Target branch: `main`
...
- Current branch: `agent/swarm-20260923-79f9381c`
- Target branch: `main`
...
```json
{
  ...
  "target_branch": "main",
  "allow_write": true,
  "session_id": "20260923-79f9381c",
  "loop_count": 6,
  "generated_at": "2026-09-23T08:33:43.032562+00:00",
  "started_at": "2026-09-23T08:33:15.331568+00:00",
  "findings": [
    "Loop 1: All deterministic checks in this loop succeeded.",
    "Loop 2: All deterministic checks in this loop succeeded.",
    "Loop 3: All deterministic checks in this loop succeeded.",
  ...
  "loop_results": [
    {
      "loop_index": 1,
      "started_at": "2026-09-23T08:33:15.581898+00:00",
      "generated_at": "2026-09-23T08:33:19.766929+00:00",
      "route": "deterministic",
      ...
      "publish_result": {
        ...
        "ok": false,
        "branch": "agent/swarm-20260923-79f9381c",
        "pr_number": 0,
        "pr_url": "",
    ...
    {
      "loop_index": 2,
      "started_at": "2026-09-23T08:33:23.301806+00:00",
      "generated_at": "2026-09-23T08:33:24.553904+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 3,
      "started_at": "2026-09-23T08:33:27.872362+00:00",
      "generated_at": "2026-09-23T08:33:29.137101+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 4,
      "started_at": "2026-09-23T08:33:32.168362+00:00",
      "generated_at": "2026-09-23T08:33:33.419581+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 5,
      "started_at": "2026-09-23T08:33:36.623184+00:00",
      "generated_at": "2026-09-23T08:33:37.893378+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 6,
      "started_at": "2026-09-23T08:33:41.576674+00:00",
      "generated_at": "2026-09-23T08:33:42.825434+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
  ...
  "git_context": {
    "current_branch": "agent/swarm-20260923-79f9381c",
    "target_branch": "main",
    "head_sha": "ea637678c0283b0ca383c5f733f91e613cc326c3",
  ...
  "git_actions": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 1 6 20260923-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.305,
      "stdout_tail": "[agent/swarm-20260923-79f9381c 113129ec] chore(agent): swarm loop 1/6 session 20260923-79f9381c\n 2 files changed, 739 insertions(+), 130 deletions(-)\nCurrent branch agent/swarm-20260923-79f9381c is up to date.\nbranch 'agent/swarm-20260923-79f9381c' set up to track 'origin/agent/swarm-20260923-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260923-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nSwitched to a new branch 'agent/swarm-20260923-79f9381c'\nremote: \nremote: Create a pull request for 'agent/swarm-20260923-79f9381c' on GitHub by visiting:        \nremote:      https://github.com/55515-code/orchestrator/pull/new/agent/swarm-20260923-79f9381c        \nremote: \nTo https://github.com/55515-code/orchestrator\n * [new branch]        agent/swarm-20260923-79f9381c -> agent/swarm-20260923-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.002,
      "stdout_tail": "agent/swarm-20260923-79f9381c\n",
      "stderr_tail": ""
    },
    {
      "command": [
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "113129ecc5fbbbd9c214a2ed87224a911cce6ebb\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 2 6 20260923-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.079,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260923-79f9381c'.\n[agent/swarm-20260923-79f9381c e084f4cb] chore(agent): swarm loop 2/6 session 20260923-79f9381c\n 2 files changed, 495 insertions(+), 18 deletions(-)\nCurrent branch agent/swarm-20260923-79f9381c is up to date.\nbranch 'agent/swarm-20260923-79f9381c' set up to track 'origin/agent/swarm-20260923-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260923-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260923-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   113129ec..e084f4cb  agent/swarm-20260923-79f9381c -> agent/swarm-20260923-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "e084f4cb0d74c6d613adea279c6aab201b86256f\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 3 6 20260923-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.815,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260923-79f9381c'.\n[agent/swarm-20260923-79f9381c 10368c2f] chore(agent): swarm loop 3/6 session 20260923-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260923-79f9381c is up to date.\nbranch 'agent/swarm-20260923-79f9381c' set up to track 'origin/agent/swarm-20260923-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260923-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260923-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   e084f4cb..10368c2f  agent/swarm-20260923-79f9381c -> agent/swarm-20260923-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "10368c2f75c657f5e2163e65b9283b09ae428c73\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 4 6 20260923-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 2.959,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260923-79f9381c'.\n[agent/swarm-20260923-79f9381c 929f0e95] chore(agent): swarm loop 4/6 session 20260923-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260923-79f9381c is up to date.\nbranch 'agent/swarm-20260923-79f9381c' set up to track 'origin/agent/swarm-20260923-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260923-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260923-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   10368c2f..929f0e95  agent/swarm-20260923-79f9381c -> agent/swarm-20260923-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "929f0e95209b7dac3a5ffcdb7601ea3dae05dfd6\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 5 6 20260923-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.477,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260923-79f9381c'.\n[agent/swarm-20260923-79f9381c ea637678] chore(agent): swarm loop 5/6 session 20260923-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260923-79f9381c is up to date.\nbranch 'agent/swarm-20260923-79f9381c' set up to track 'origin/agent/swarm-20260923-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260923-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260923-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   929f0e95..ea637678  agent/swarm-20260923-79f9381c -> agent/swarm-20260923-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "ea637678c0283b0ca383c5f733f91e613cc326c3\n",
      "stderr_tail": ""
    },
    {
      "command": [
