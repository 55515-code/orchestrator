...
- Generated at: 2026-09-22T08:31:54.550437+00:00
- Session: `20260922-79f9381c`
- Mode: `deep`
- Loop count: `6`
- Route: `cloud_agent`
- Target branch: `main`
...
- Current branch: `agent/swarm-20260922-79f9381c`
- Target branch: `main`
...
```json
{
  ...
  "target_branch": "main",
  "allow_write": true,
  "session_id": "20260922-79f9381c",
  "loop_count": 6,
  "generated_at": "2026-09-22T08:31:54.550437+00:00",
  "started_at": "2026-09-22T08:31:26.506964+00:00",
  "findings": [
    "Loop 1: All deterministic checks in this loop succeeded.",
    "Loop 2: All deterministic checks in this loop succeeded.",
    "Loop 3: All deterministic checks in this loop succeeded.",
  ...
  "loop_results": [
    {
      "loop_index": 1,
      "started_at": "2026-09-22T08:31:26.836539+00:00",
      "generated_at": "2026-09-22T08:31:30.670673+00:00",
      "route": "deterministic",
      ...
      "publish_result": {
        ...
        "ok": false,
        "branch": "agent/swarm-20260922-79f9381c",
        "pr_number": 0,
        "pr_url": "",
    ...
    {
      "loop_index": 2,
      "started_at": "2026-09-22T08:31:35.071048+00:00",
      "generated_at": "2026-09-22T08:31:35.868611+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 3,
      "started_at": "2026-09-22T08:31:39.882224+00:00",
      "generated_at": "2026-09-22T08:31:40.666001+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 4,
      "started_at": "2026-09-22T08:31:44.368549+00:00",
      "generated_at": "2026-09-22T08:31:45.169002+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 5,
      "started_at": "2026-09-22T08:31:48.846110+00:00",
      "generated_at": "2026-09-22T08:31:49.613443+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
    ...
    {
      "loop_index": 6,
      "started_at": "2026-09-22T08:31:53.475896+00:00",
      "generated_at": "2026-09-22T08:31:54.233926+00:00",
      "route": "deterministic",
      "cloud_attempted": false,
      "cloud_success": false,
      "cloud_note": "Cloud command not configured; skipping cloud route.",
  ...
  "git_context": {
    "current_branch": "agent/swarm-20260922-79f9381c",
    "target_branch": "main",
    "head_sha": "db094ae5d61b064104ad423cb82c1500607ee121",
  ...
  "git_actions": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 1 6 20260922-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.971,
      "stdout_tail": "[agent/swarm-20260922-79f9381c 492cac6c] chore(agent): swarm loop 1/6 session 20260922-79f9381c\n 2 files changed, 739 insertions(+), 130 deletions(-)\nCurrent branch agent/swarm-20260922-79f9381c is up to date.\nbranch 'agent/swarm-20260922-79f9381c' set up to track 'origin/agent/swarm-20260922-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260922-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nSwitched to a new branch 'agent/swarm-20260922-79f9381c'\nremote: \nremote: Create a pull request for 'agent/swarm-20260922-79f9381c' on GitHub by visiting:        \nremote:      https://github.com/55515-code/orchestrator/pull/new/agent/swarm-20260922-79f9381c        \nremote: \nTo https://github.com/55515-code/orchestrator\n * [new branch]        agent/swarm-20260922-79f9381c -> agent/swarm-20260922-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "agent/swarm-20260922-79f9381c\n",
      "stderr_tail": ""
    },
    {
      "command": [
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "492cac6ce267c6fbba404dca34aa454d31a16e26\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 2 6 20260922-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.677,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260922-79f9381c'.\n[agent/swarm-20260922-79f9381c dc422a46] chore(agent): swarm loop 2/6 session 20260922-79f9381c\n 2 files changed, 495 insertions(+), 18 deletions(-)\nCurrent branch agent/swarm-20260922-79f9381c is up to date.\nbranch 'agent/swarm-20260922-79f9381c' set up to track 'origin/agent/swarm-20260922-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260922-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260922-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   492cac6c..dc422a46  agent/swarm-20260922-79f9381c -> agent/swarm-20260922-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "dc422a46abda0fe0ccc154ae122d4df0d612bbe2\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 3 6 20260922-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.361,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260922-79f9381c'.\n[agent/swarm-20260922-79f9381c e2a809cd] chore(agent): swarm loop 3/6 session 20260922-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260922-79f9381c is up to date.\nbranch 'agent/swarm-20260922-79f9381c' set up to track 'origin/agent/swarm-20260922-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260922-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260922-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   dc422a46..e2a809cd  agent/swarm-20260922-79f9381c -> agent/swarm-20260922-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "e2a809cd1f9b10b4358370d397aa2feb322e0785\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 4 6 20260922-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.374,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260922-79f9381c'.\n[agent/swarm-20260922-79f9381c 5263fffd] chore(agent): swarm loop 4/6 session 20260922-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260922-79f9381c is up to date.\nbranch 'agent/swarm-20260922-79f9381c' set up to track 'origin/agent/swarm-20260922-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260922-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260922-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   e2a809cd..5263fffd  agent/swarm-20260922-79f9381c -> agent/swarm-20260922-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "5263fffdb848797bb845f7fa218a0911b238776c\n",
      "stderr_tail": ""
    },
    {
      "command": [
    ...
    },
    {
      ...
      "command_text": "bash scripts/agent_hybrid_publish.sh true main /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md 5 6 20260922-79f9381c safe_gate 1 true",
      "return_code": 0,
      "ok": true,
      "duration_seconds": 3.529,
      "stdout_tail": "M\tartifacts/agent-hybrid/agent_report.md\nM\tartifacts/agent-hybrid/agent_summary.json\nYour branch is up to date with 'origin/agent/swarm-20260922-79f9381c'.\n[agent/swarm-20260922-79f9381c db094ae5] chore(agent): swarm loop 5/6 session 20260922-79f9381c\n 2 files changed, 486 insertions(+), 11 deletions(-)\nCurrent branch agent/swarm-20260922-79f9381c is up to date.\nbranch 'agent/swarm-20260922-79f9381c' set up to track 'origin/agent/swarm-20260922-79f9381c'.\nAGENT_PUBLISH_ACTION=pr_create_failed\nAGENT_PUBLISH_OK=false\nAGENT_PUBLISH_BRANCH=agent/swarm-20260922-79f9381c\nAGENT_PUBLISH_PR_NUMBER=\nAGENT_PUBLISH_PR_URL=\nAGENT_PUBLISH_MERGE_ATTEMPTED=false\nAGENT_PUBLISH_MERGED=false\nAGENT_PUBLISH_MERGE_ATTEMPTS=0\nAGENT_PUBLISH_REBASE_OK=true\nAGENT_PUBLISH_PUSH_OK=true\nAGENT_PUBLISH_MESSAGE=Failed to create PR from rolling branch.\n",
      "stderr_tail": "From https://github.com/55515-code/orchestrator\n * branch              main       -> FETCH_HEAD\nAlready on 'agent/swarm-20260922-79f9381c'\nTo https://github.com/55515-code/orchestrator\n   5263fffd..db094ae5  agent/swarm-20260922-79f9381c -> agent/swarm-20260922-79f9381c\nscripts/agent_hybrid_publish.sh: line 64: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_summary.json\\: No such file or directory\nscripts/agent_hybrid_publish.sh: line 65: /home/runner/work/orchestrator/orchestrator/artifacts/agent-hybrid/agent_report.md\\: No such file or directory\npull request create failed: GraphQL: GitHub Actions is not permitted to create or approve pull requests (createPullRequest)\n"
    },
    {
      "command": [
        "git",
    ...
    },
    {
      ...
      "ok": true,
      "duration_seconds": 0.001,
      "stdout_tail": "db094ae5d61b064104ad423cb82c1500607ee121\n",
      "stderr_tail": ""
    },
    {
      "command": [
